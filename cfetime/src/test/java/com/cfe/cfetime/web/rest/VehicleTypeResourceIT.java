...
import static com.cfe.cfetime.domain.VehicleTypeAsserts.*;
...
class VehicleTypeResourceIT {
    ...
    public static VehicleType createEntity(EntityManager em) {
        VehicleType vehicleType = new VehicleType().descripcion(DEFAULT_DESCRIPCION);
        return vehicleType;
    }
    ...
    public static VehicleType createUpdatedEntity(EntityManager em) {
        VehicleType vehicleType = new VehicleType().descripcion(UPDATED_DESCRIPCION);
        return vehicleType;
    }
    ...
    void checkDescripcionIsRequired() throws Exception {
        ...
        // set the field null
        vehicleType.setDescripcion(null);
    ...
    void putExistingVehicleType() throws Exception {
        ...
        updatedVehicleType.descripcion(UPDATED_DESCRIPCION);
    ...
    void fullUpdateVehicleTypeWithPatch() throws Exception {
        ...
        partialUpdatedVehicleType.descripcion(UPDATED_DESCRIPCION);
