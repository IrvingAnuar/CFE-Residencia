...
describe('EmployeeAttendance e2e test', () => {
  ...
  // const employeeAttendanceSample = {"attendanceDate":"2024-09-04","checkInTime":"2024-09-04T18:47:35.990Z"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/employees',
      body: {"clave":29302,"name":"generously manifestation","firstSurname":"seriously likewise","secondSurname":"setback boohoo accelerant","createdDate":"2024-09-04T20:59:43.579Z","lastModifiedDate":"2024-09-04T16:58:20.986Z"},
    }).then(({ body }) => {
      employee = body;
    });
    // create an instance at the required relationship entity:
  ...
  describe('new EmployeeAttendance page', () => {
    ...
    it.skip('should create an instance of EmployeeAttendance', () => {
      cy.get(`[data-cy="attendanceDate"]`).type('2024-09-04');
      cy.get(`[data-cy="attendanceDate"]`).blur();
      cy.get(`[data-cy="attendanceDate"]`).should('have.value', '2024-09-04');

      cy.get(`[data-cy="checkInTime"]`).type('2024-09-04T17:36');
      cy.get(`[data-cy="checkInTime"]`).blur();
      cy.get(`[data-cy="checkInTime"]`).should('have.value', '2024-09-04T17:36');

      cy.get(`[data-cy="checkOutTime"]`).type('2024-09-04T21:10');
      cy.get(`[data-cy="checkOutTime"]`).blur();
      cy.get(`[data-cy="checkOutTime"]`).should('have.value', '2024-09-04T21:10');
