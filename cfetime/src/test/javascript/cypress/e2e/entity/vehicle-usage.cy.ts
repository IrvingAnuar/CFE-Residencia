...
describe('VehicleUsage e2e test', () => {
  ...
  // const vehicleUsageSample = {"startDate":"2024-09-08T04:14:45.274Z"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/employees',
      body: {"clave":28142,"name":"carelessly","firstSurname":"questionable ack wonderful","secondSurname":"ram","createdDate":"2024-09-07T23:50:10.059Z","lastModifiedDate":"2024-09-08T07:20:10.516Z"},
    }).then(({ body }) => {
      employee = body;
    });
    // create an instance at the required relationship entity:
  ...
  describe('new VehicleUsage page', () => {
    ...
    it.skip('should create an instance of VehicleUsage', () => {
      cy.get(`[data-cy="startDate"]`).type('2024-09-08T14:04');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-09-08T14:04');

      cy.get(`[data-cy="endDate"]`).type('2024-09-08T02:51');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-09-08T02:51');
