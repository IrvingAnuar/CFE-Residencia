...
describe('Employee e2e test', () => {
  ...
  // const employeeSample = {"createdDate":"2024-09-04T20:04:40.507Z"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/users',
      body: {"login":"bmw.","firstName":"Inés","lastName":"Archuleta Puente","email":"Estela.RamirezBahena86@gmail.com","imageUrl":"woot except","langKey":"ultimately"},
    }).then(({ body }) => {
      user = body;
    });
  });
  ...
  describe('new Employee page', () => {
    ...
    it.skip('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2024-09-04T18:57');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-09-04T18:57');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2024-09-04T16:01');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2024-09-04T16:01');
