...
/**
 * REST controller for managing {@link com.cfe.cfetime.domain.Employee}.
 */
@RestController
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                if (employee.getClave() != null) {
                    existingEmployee.setClave(employee.getClave());
                }
                if (employee.getName() != null) {
                    existingEmployee.setName(employee.getName());
                }
                if (employee.getFirstSurname() != null) {
                    existingEmployee.setFirstSurname(employee.getFirstSurname());
                }
                if (employee.getSecondSurname() != null) {
                    existingEmployee.setSecondSurname(employee.getSecondSurname());
                }
