...
import reducer, { getEntities, getEntity, reset } from './status-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATUSTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATUSTYPE actions', async () => {
      const arg = 42666;
