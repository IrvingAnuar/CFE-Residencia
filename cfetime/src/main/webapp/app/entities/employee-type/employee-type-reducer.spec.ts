...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLOYEETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLOYEETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EMPLOYEETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLOYEETYPE actions', async () => {
      const arg = 42666;
