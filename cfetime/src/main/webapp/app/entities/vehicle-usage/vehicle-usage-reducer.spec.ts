...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEUSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEUSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEUSAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEUSAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEUSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEUSAGE actions', async () => {
      const arg = 42666;
